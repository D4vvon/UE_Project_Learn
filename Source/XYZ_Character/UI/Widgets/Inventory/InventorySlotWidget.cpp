...
#include "Characters/Components/CharacterComponents/CharacterInventoryComponent.h"
...
void UInventorySlotWidget::UpdateView()
{
	...
	{
		const FInvetoryItemDesription& Description = LinkedSlot->Item->GetDescription();
...
FReply UInventorySlotWidget::NativeOnMouseButtonDown(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
	...
	if (MouseBtn == EKeys::RightMouseButton)
	{
		...
		AXYZBaseCharacter* ItemOwner = Cast<AXYZBaseCharacter>(LinkedSlotItem->GetOuter());
