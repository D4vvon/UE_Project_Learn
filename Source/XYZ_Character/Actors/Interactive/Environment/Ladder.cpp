...
ALadder::ALadder()
{
	RootComponent = CreateDefaultSubobject<USceneComponent>(TEXT("LsdderRoot"));
...
void ALadder::OnConstruction(const FTransform& Transform)
{
	...
	GetLadderInteractionBox()->SetBoxExtent(FVector(BoxDepthExtent, LadderWidth * 0.5, LadderHeight * 0.5f));
...
//	OrientationRotation.Pitch = 0.0f;
//	OrientationRotation.Roll = 0.0f;
//	OrientationRotation.Yaw = 180.0f;
